                    ...
                    unidade.nome }}</div>
                        ...
                        <div class="">
                            <div class="flex gap-10 mt-5 mx-5">
                                ...
                                <a :href="'/download-excel/' + solicitacao.id" class="">

                                    <svg width="21" height="21" xmlns="http://www.w3.org/2000/svg"
                                        style="st0{fill:#515151;stroke:#515151;stroke-width:0.9276;stroke-miterlimit:10;}"
                                        xmlns:svg="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24"
                                                    ...
                                                    <span v-for="fotos in solicitacao.resposta.fotos" :key="fotos.id"
                                                        ...
                                                        <a class="cursor-pointer" :href="folderImg + fotos.foto"
                                                            ...
                                                            <img :src="folderImg + fotos.foto"
                                                                class="rounded-sm w-36 h-36 " alt="">
                                                        </a>
                                                    </span>
                                                    <span v-if="solicitacao.fotos.length > 3"
                                                        class="flex items-center justify-center w-12">
                                                        <box-icon name='plus-medical' color="#0072bb"
                                                            size="sx"></box-icon>
                                                    </span>
                                                </div>
                                            </div>
