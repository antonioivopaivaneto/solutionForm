...
const removerTodas = (condominio) => {
    ...
    router.delete(route("unidades.destroyAll", condominio), {
        preserveScroll: true,
    });
...
const pesquisa = (search,valor) => {
    ...
    router.get(route("condominios.show", { ...route().params,[search]: valor }), {
        preserveScroll: true,
        preserveState: true,
    });
};
    ...
    <AuthenticatedLayout>
        <div class="max-w-8xl mx-auto sm:px-7 lg:px-9 mt-9">
            ...
            <div class="flex flex-row">
                <div
                    class="p-4 mx-auto bg-white border border-gray-200 rounded-lg shadow-lg"
                >
                    ...
                    <div class="flex">
                        <a
                            target="&_blank"
                            :href="route('imprimir', condominio.id)"
                ...
                <div
                    class="w-full max-w-md p-4 mx-auto bg-white border border-gray-200 rounded-lg shadow-lg sm:p-8"
                >
                    <form @submit.prevent="submit">
                                ...
                                <TextInput
                                    :class="{
                                        'bg-gray-200 cursor-not-allowed':
                                            form.qtd_andares_disabled,
                                    }"
                                    :disabled="form.qtd_andares_disabled"
                                    id="Torre"
                                    type="text"
                                    class="mt-1 block w-full"
                                    v-model="form.qtd_andares"
                                    autocomplete="new-password"
                                />
                                <InputError
                                    class="mt-2"
                                    :message="form.errors.qtd_andares"
                                />
                            </div>
                            <div class="mt-4">
                                <InputLabel
                                    for="unidades_intervalo"
                                    value="Numeração Andar"
                                />
                                <TextInput
                                    id="numeracao"
                                    type="text"
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div class="mt-4">
                                ...
                                <TextInput
                                    :class="{
                                        'bg-gray-200 cursor-not-allowed':
                                            form.qtd_total_disabled,
                                    }"
                                    :disabled="form.qtd_total_disabled"
                                    id="Torre"
                                    type="text"
                                    class="mt-1 block w-full"
                        ...
                        <div>
                            Exemplo de nomeação:
                            {{ apName(form.torre, form.unidades, form.bloco) }}
                        </div>
                    ...
                    <form @submit.prevent="submitCond(condominio.id)">
                        ...
                        <div>
                            ...
                            <TextInput
                                ...
                                autocomplete="cnpj"
                                :class="{
                                    'border-gray-100': validadoCnpj === true,
                                    'border-red-500': validadoCnpj === false,
                                }"
                            />
                            <InputError
                                class="mt-2"
                        ...
                        <div>
                            ...
                            <InputError
                                class="mt-2"
                                :message="formcond.errors.endereco"
                            />
                        </div>
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <PrimaryButton
                                class="ml-4"
                                :class="{ 'opacity-25': formcond.processing }"
            ...
            <div class="py-9">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class="flex items-center gap-5  mx-5">
                        ...
                        <div class="mb-5 w-80">
                            ...
                            <input
                                type="text"
                                @keyup.enter="
                                    pesquisa('pesquisaUnidade', pesquisaUnidade)
                                "
                                v-model="pesquisaUnidade"
                    ...
                    <div class="relative overflow-x-auto sm:rounded-lg p-5">
                        ...
                        >
                            <thead
                                class="text-xs text-gray-700 uppercase bg-gray-50 border-b-2 border-gray-500"
                            >
                            ...
                            <tbody>
                                ...
                                >
                                    ...
                                    <th
                                        scope="row"
                                        class="px-3 py-4 font-medium cursor-pointer"
                                    >
                                        <Link
                                            class="text-blue-500"
                                            :href="'/unidades/' + cond.id"
                        ...
                        >
                            Total de unidades: {{ unidades.data.length }}
                        </div>
