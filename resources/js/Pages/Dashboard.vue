...
const processarLabel = (label) => {
    ...
    return label
        .replace(/&laquo;/g, "")
        .replace("Previous", "Voltar")
        .replace("Next", "Proximo")
        .replace(/&raquo;/g, "");
};
...
onMounted(() => {
    ...
    if (queryParams.has("pesquisaCondominio")) {
        pesquisaCond.value = queryParams.get("pesquisaCondominio");
    }
    if (queryParams.has("pesquisaLocal")) {
        pesquisaLocais.value = queryParams.get("pesquisaLocal");
    }
                ...
                <div class="grid grid-cols-4 gap-5">
                    ...
                    >
                        <div class="flex items-center justify-between mb-4">
                            ...
                            >
                                <span class="text-4xl">Condominios</span><br />
                                com maior requisicao
                            </h5>
                        </div>
                        <div class="flow-root">
                            <ul
                    ...
                    >
                        <div class="flex items-center justify-between mb-4">
                            ...
                            >
                                <span class="text-4xl">Unidade</span><br />
                                com maior requisicao
                            </h5>
                        </div>
                        <div class="flow-root">
                    ...
                    >
                        <div class="flex items-center justify-between mb-4">
                            <h5
                                class="text-xl font-bold leading-none text-gray-900 dark:text-white"
                            >
                                <span class="text-4xl">Resumo</span
                                ><br />Andamento por Status
                            </h5>
                        </div>
                        <div class="flow-root">
                            <ul
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class="overflow-x-auto sm:rounded-lg px-5 mr-5">
                        ...
                        >
                            ...
                            >
                                <tr class="bg-gray-500 text-white text-nowrap">
                                    ...
                                    <th
                                        scope="col"
                                        class="px-6 py-3 flex justify-center gap-2 cursor-pointer"
                                    >
                                        <a @click="filtro('assunto')"
                                            >Assunto</a
                                        >
                                        <svg
                                            v-if="true"
                        ...
                        <div class="mt-4 flex gap-2 items-center mb-10">
                            ...
                            >
                                <span>{{
                                    processarLabel(solicitacao.label)
                                }}</span>
                            </a>
                        </div>
                    </div>
